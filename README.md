...
docker run -it openos365/openos365-10006-openeuler-latest-docker-main-root:latest bash
```
#### www

```
docker pull openos365/openos365-10006-openeuler-latest-docker-main-www:latest
docker run -it openos365/openos365-10006-openeuler-latest-docker-main-www:latest bash
```
